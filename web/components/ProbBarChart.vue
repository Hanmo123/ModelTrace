  ...
  <div class="flex flex-col gap-1">
    <div class="relative h-44 pl-9">
      ...
      <div
        ...
        aria-hidden="true"
      >
        <span class="tnum absolute -left-9 w-8 text-right text-[10px] text-muted-foreground">
          {{ line }}%
        </span>
        <div class="w-full border-t border-dashed border-border" />
      </div>
      <span
        class="tnum absolute -left-9 bottom-0 w-8 translate-y-1/2 text-right text-[10px] text-muted-foreground"
        aria-hidden="true"
      >0%</span>
